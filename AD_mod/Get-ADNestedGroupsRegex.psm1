function Get-ADNestedGroupsRegex {
    <#
.Synopsis
...
#>
    ...
    [PoshBot.BotCommand(
        Command = $false,
        CommandName = 'Get-ADNestedGroupsRegex',
        TriggerType = 'regex',
        Regex = "%"
    )]
    [cmdletbinding()]
...
try {
    ...
    $gwoops = Get-ADNestedGroups -GroupName $gwipe -ErrorAction stop | select name | Sort-Object name
